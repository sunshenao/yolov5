...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default=r'/kaggle/working/logs')
    parser.add_argument('--batch', type=int, default=8)
    parser.add_argument('--model_path', type=str, default=r'')
    parser.add_argument('--phi', type=str, default=r'm')

    # save_dir            = '/kaggle/working/logs' #/kaggle/working/
    # Unfreeze_batch_size model_path phi
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    # model_data/yolov5_s.pth  #model_data/yolov5_m.pth
    ...
    #------------------------------------------------------------------#
    save_dir            = opt.save_dir #/kaggle/working/
    #------------------------------------------------------------------#
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch(model_train, model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir, local_rank) #dadasd
